...
CS_XML_NS = 'https://doc.s3.amazonaws.com/2006-03-01'
...
def dt_str_to_posix(dt_str):
  ...
  A pointer: https://www.cl.cam.ac.uk/~mgk25/iso-time.html
...
def local_api_url():
  ...
  return 'https://%s%s' % (os.environ.get('HTTP_HOST'), LOCAL_GCS_ENDPOINT)
