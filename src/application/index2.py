...
class Index2(webapp2.RequestHandler):
    ...
    def post(self):
        ...
        self.tmpl_val = {}
        self.tmpl_val['bkdataurl'] = 'https://s-style-hrd.appspot.com/show/s-style/hon/www.chikusaku-mansion.com/bkdata/article.html?media=web&id='
        ...
        self.tmpl_val['newdata'] = list


        path = os.path.join( os.getcwd(),'templates','index2.html')
